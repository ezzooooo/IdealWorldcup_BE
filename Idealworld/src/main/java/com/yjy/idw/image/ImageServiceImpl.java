...
public class ImageServiceImpl implements ImageService {
	...
	@Override
	public void insertImage(ImageVO vo, MultipartFile f) {
        ...
        try {
	        ...
	        meta.setContentLength(f.getBytes().length);
	        meta.setContentType("image/jpeg");
	        s3.putObject(new PutObjectRequest(bucketName, key, f.getInputStream(), meta));
